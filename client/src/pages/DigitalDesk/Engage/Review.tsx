...
import { ReviewTableData } from "@/data/Data";
// Alias to reuse existing state logic without refactor
const CourseTable = ReviewTableData;
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-bold text-[var(--text-head)]">Reviews </h1>
        <StatsCards />
   <Topbar  />
    ...
    <div className="flex justify-between px-4 py-3 bg-[var(--background)] rounded-sm gap-4 border flex-wrap shadow-none">
      ...
      <div className="flex gap-4 flex-wrap">
        <Button variant="standard" size="new">
          ...
          <span className="">  View Rating Analytics</span>
        </Button>
        <Button variant="standard" size="new">
        ...
        <Button variant="standard" size="new">
          ...
          <span className="">Import Review Logs</span>
        </Button>
        <Button
          variant="border"
...
function TableSection() {
  ...
  if (sortConfig !== null) {
    ...
    sortedData.sort((a, b) => {
      ...
      if (key === "createdOn" || key === "created_on" || key === "lastUpdated" || key === "Created On" || key === "submittedOn") {
            ...
            <TableBody className="overflow-visible relative z-0">
              {currentRecords.map((user) => (
                ...
                >
                  ...
                  <TableCell>
                    <div className="text-low">{user.submittedOn}</div>
                  </TableCell>
                  <TableCell>
                    <div className="text-low">{user.submittedFor}</div>
                  </TableCell>
                  <TableCell>
                    <div className="text-low">{user.submittedBy}</div>
                  </TableCell>
                  <TableCell>
                    <div className="text-low">{user.rating}</div>
                  </TableCell>
                  <TableCell>
                    <div className="text-low max-w-[200px] truncate">{user.content}</div>
                  </TableCell>
                  <TableCell>
