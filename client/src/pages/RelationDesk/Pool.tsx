...
function AdvancedFilters({ onClose }: FilterProps) {
    ...
    const [leads, setLeads] = useState("Recently Active");
    const [cases, setCases] = useState("Missed Session");
...
function TableSection() {
    ...
    const handleRowClick = (user: (typeof PoolTable)[0]) => {
                  ...
                  >
                    ...
                    <TableCell>
                      ...
                      <div className="text-low">{user.Objective}</div>
                        ...
                        <TableCell>
                            <div className="text-sm">{user.for}</div>
                        </TableCell>
                        <TableCell>
