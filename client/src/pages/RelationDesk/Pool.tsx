...
// import { PoolTable, SurveysTable } from "@/data/Data";
...
//         <h1 className="text-2xl font-bold text-[var(--text-head)]">Pool</h1>
//         <StatsCards />
//         <Topbar />
...
// //   } | null>(null);
// //   const [selectedStack, setSelectedStack] = useState<typeof PoolTable>(
