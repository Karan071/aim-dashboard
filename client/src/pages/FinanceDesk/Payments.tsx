...
function TableSection() {
  ...
  >(paymentsTable[0] ? [paymentsTable[0]] : []);
  const [focusedId, setFocusedId] = useState<number | null>(paymentsTable[0]?.id || null);
  ...
  */
  ...
  const handleRowClick = (user: (typeof paymentsTable)[0]) => {
