...
const tableData = [
    {
      ...
      "status": "Explorer Joined",
      "actions": ["View", "Cancel", "Flag", "Logs:Booked", "Logs:Explorer Joined"]
    },
    {
      "id": "SES1002",
      "explorer": {
      ...
      "status": "Coach Joined",
      "actions": ["View", "Cancel", "Flag", "Logs:Accepted", "Logs:Coach Joined"]
    },
    {
      "id": "SES1003",
      "explorer": {
      ...
      "amount": 1200,
      "fees": "1200 | 25%",
      "share": "Platform: 900 | Coach: 300",
      "status": "In Progress",
      "actions": ["View", "Cancel", "Flag", "Logs:Booked", "Logs:Accepted", "Logs:Explorer Joined", "Logs:Coach Joined"]
    }
  ]
