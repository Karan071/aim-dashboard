...
import { ChevronDown, Filter, ChevronRight, ChevronLeft, PenSquare, Pin, Bell, FileDown, Eye, Pen, X, Users, FileCheck2, FileText, CheckCircle2, CircleArrowUp, CircleArrowDown } from "lucide-react";
...
export function JobApplication() {
    ...
    return (
        <div className="flex flex-col gap-2">
            <h1 className="text-2xl font-bold text-[var(--text-head)]">Job Application </h1>
            <StatCard />
            <Buttonbar />
            <TableSection />
        </div>
                                ...
                                >
                                    ...
                                    >
                                        <Checkbox
                                            ...
                                            onCheckedChange={() => toggleSelectUser(user.application_id)}
                                        />
                                    </TableCell>
                                    <TableCell>
