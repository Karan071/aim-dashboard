...
// import { GoogleMapReview } from "@/data/Data";
...
//             <h1 className="text-2xl font-bold text-[var(--text-head)]">Map Listing</h1>
//             <GoogleTable/>
//         </div>
//     )
// }
...
//         typeof GoogleMapReview
//     >(GoogleMapReview[0] ? [GoogleMapReview[0]] : []);
//     const [focusedId, setFocusedId] = useState<number | null>(GoogleMapReview[0]?.id || null);

//     // Sorting logic
//     const sortedData = [...GoogleMapReview];
//     if (sortConfig !== null) {
//         sortedData.sort((a, b) => {
...
//     const handleRowClick = (user: (typeof GoogleMapReview)[0]) => {
...
//                                         />
//                                         </TableCell>
//                                     <TableCell className="font-medium">{user.Listing}</TableCell>
//                                                             <TableCell>{user.Address}</TableCell>
//                                                             <TableCell>{user.LinkedOrg}</TableCell>
